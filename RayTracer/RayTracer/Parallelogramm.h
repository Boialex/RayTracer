...
class Parallelogramm : public IFigure {
public:
    Parallelogramm() : _A(), _B(), _C(), _D(), _color(0, 0, 0) {};
    Parallelogramm(const long double reflection, const long double refraction, const Color color,
